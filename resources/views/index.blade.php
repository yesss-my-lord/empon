...
<html lang="{{ $locale }}">
  <head>
    @if( env('APP_ENV') == 'production')
      ...
      <script>
        ...
        })(window,document,'script','dataLayer','GTM-5W9S5BR');
      </script>
  ...
  <body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5W9S5BR" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
